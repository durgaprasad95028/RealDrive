...
export const CarsSelectionPage: React.FC<CarsSelectionPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-[#090A0F] text-[#F8FAFC] pb-16 selection:bg-blue-600 selection:text-white">
      {/* Stitch Top Navigation Bar */}
      <header className="sticky top-0 z-30 stitch-glass-elevated border-b border-white/10 px-6 py-4 flex items-center justify-between max-w-7xl mx-auto rounded-b-3xl">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2 px-3.5 py-1.5 rounded-full stitch-glass font-mono text-xs">
          ...
          <Button
            ...
            className="shadow-[0_0_20px_rgba(59,130,246,0.4)] rounded-2xl uppercase font-bold text-xs tracking-wider"
          >
          ...
          <div className="relative p-6 sm:p-8 rounded-3xl stitch-glass-elevated border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="relative z-10 space-y-2.5">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2 font-mono text-xs">
                <div className="p-3 rounded-2xl stitch-glass border border-white/5">
                  <span className="text-[10px] text-slate-400 uppercase block">Top Speed</span>
                  <span className="text-sm font-bold text-cyan-400">{selectedVehicle.topSpeedKmH} km/h</span>
                </div>
                <div className="p-3 rounded-2xl stitch-glass border border-white/5">
                ...
                <div className="p-3 rounded-2xl stitch-glass border border-white/5">
                  <span className="text-[10px] text-slate-400 uppercase block">0-100 km/h</span>
                  <span className="text-sm font-bold text-emerald-400">{selectedVehicle.acceleration0To100}s</span>
                </div>
                <div className="p-3 rounded-2xl stitch-glass border border-white/5">
                  <span className="text-[10px] text-slate-400 uppercase block">Condition</span>
                  <span className="text-sm font-bold text-cyan-300">{selectedVehicle.overallCondition}%</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-xs font-mono font-bold transition-all ${
                activeTab === 'all'
                  ...
                  : 'stitch-glass text-slate-400 hover:text-white'
              }`}
            >
            ...
            return (
              <div
                ...
                className={`relative rounded-3xl p-6 transition-all duration-300 flex flex-col justify-between ${
                  isSelected
                    ? 'stitch-glass-elevated border-2 border-cyan-400/80 shadow-[0_0_35px_rgba(6,182,212,0.25)]'
                    : 'stitch-glass border border-white/10 hover:border-white/20'
                }`}
              >
                {/* Card Top Header */}
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    {v.isOwned ? (
                      isSelected ? (
                        <span className="stitch-pill text-cyan-300">ACTIVE</span>
                      ) : (
                  ...
                  <div className="space-y-2 pt-2 text-xs font-mono">
                    <div className="flex justify-between items-center text-slate-300">
                      ...
                      <span className="font-bold text-cyan-400">{v.topSpeedKmH} km/h</span>
                    </div>
                    <div className="w-full h-1.5 rounded-full bg-black/40 overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-blue-500 to-cyan-400" style={{ width: `${Math.min(100, (v.topSpeedKmH / 320) * 100)}%` }} />
                    </div>

                    <div className="flex justify-between items-center text-slate-300">
                      <span className="text-slate-400">Acceleration (0-100):</span>
                  ...
                  {v.isOwned ? (
                    isSelected ? (
                      <Button
                        ...
                        leftIcon={<Play className="w-4 h-4 fill-current" />}
                        onClick={handleStartDriving}
                        className="w-full shadow-[0_0_20px_rgba(59,130,246,0.4)] rounded-xl uppercase font-bold text-xs"
                      >
                        DRIVE THIS CAR
                      </Button>
                    ) : (
                      <Button
                        ...
                        className="w-full uppercase font-bold text-xs stitch-glass rounded-xl"
                      >
                        SELECT AS ACTIVE
                      </Button>
                    )
                    ...
                    <Button
                      ...
                      className="w-full uppercase font-bold text-xs rounded-xl"
                    >
